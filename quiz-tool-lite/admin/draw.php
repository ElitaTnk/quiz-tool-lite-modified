...
//							$correctStr = $optionValue;
				...
				$questionStr.= '<input type="submit" value="'.$buttonText.'"testeli onclick="';
	...
	//					$optionID= $myOptions['optionID'];
				...
				while($i<=$blankCount)
				{
					...
					$blank_feedback.='<div style="margin:5px 0px 5px 0px; padding:5px; border:1px solid #ccc"><b>Blank '.$i.' : Possible Correct Answers asasas</b><br/>';
					$blank_feedback.= "<ol>";
