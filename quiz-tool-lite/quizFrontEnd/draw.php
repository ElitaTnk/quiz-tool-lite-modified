...
//							$correctStr = $optionValue;
							...
							if($blankCount>=1)
							{
								...
								while($i<=$blankCount)
								{
									$tempCorrectStr = ${'answers'.$i};
									$tempCorrectStr = rawurlencode($tempCorrectStr);

									$correctStr.= $tempCorrectStr.'|';

									//echo "<script>console.log(".json_encode($correctStr).");</script>";
				...
				$questionStr.= '<input type="submit" value="'.$buttonText.'" testeli2 onclick="';
